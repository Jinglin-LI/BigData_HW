...
public class CountYelp_Top10Rating {
	...
	public static void main(String[] args) throws Exception {
		...
		String[] otherArgs = new GenericOptionsParser(conf, args).getRemainingArgs();
	      if (otherArgs.length != 2) {
	          System.err.println("Usage: CountYelp_Top10Rating <in> <out>");
	          System.exit(2);
	      }
	      Job job = Job.getInstance(conf);
	      job.setJobName("CountYelp_Top10Rating");
	      job.setJarByClass(CountYelp_Top10Rating.class);
